 ...
 * It contains the following 15 variables: `r variable.names(early_january_weather)`. A summary is as follows: `r knitr::kable(summary(early_january_weather), digits = 2)`  
